#!/usr/bin/env python
#
# Script to register one or more input images to a reference image.  
# 
...
def register_channels_native( infiles, outdir, reference_image=0, image_type='geneseq', cp=None):
    '''
    For infile, register to reference image and write to outdir.  
