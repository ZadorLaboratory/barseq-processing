...
# CODE FROM NOTEBOOK
#
def basecall_hyb_all_tiles(pth, cyclename, codebook_hyb_name,thresh,prominence,num_c=4,all_genes_ch=2,no_deconv=1):
    """
    Basecalling function:
...
def quantify_peaks_notebook(lroi_x,lroi_y,id_t,sig_t,m,hyb_2):
    """
    Basecalling function:
    1. Based on the regionprops results per tile, this function creates hyb basecalling output and decodes the gene
    2. Returns the basecall output to the calling function
